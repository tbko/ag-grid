...
module ag.grid {
    ...
    export function groupHeaderFactory(gridOptionsWrapper: GridOptionsWrapper,
                                    selectionRendererFactory: SelectionRendererFactory,
                                    expressionService: ExpressionService) {

        return function oldGroupCellRenderer(params: any) {
            // console.log('div/', {
            //     class: ['a', 'b']
            // });
            return '<div></div>';
        ...
        function oldGroupCellRenderer(params: any) {
